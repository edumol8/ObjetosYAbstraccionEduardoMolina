...
/*
	private void agregarEstudianteAMesa() {
	    ...
	    if (mesa != null && estudianteSeleccionadoObj != null) {
	        ...
	        estudianteSeleccionado.setMesaDelEstudiante(mesa);//eliminar??
	...
	}*///100% confiable pero se duplicaba
	...
	private void agregarEstudianteAMesa() {
	    ...
	    if (mesaSeleccionada != null && estudianteSeleccionadoObj != null) {
	        Estudiante estudianteSeleccionado = (Estudiante) estudianteSeleccionadoObj;
	        // Verificar si el estudiante ya está asignado a una mesa
	        if (estudianteSeleccionado.getMesaDelEstudiante() == null) {
	            ...
	            // No es necesario agregar la mesa a la lista de mesas, ya que ya existe en la lista
