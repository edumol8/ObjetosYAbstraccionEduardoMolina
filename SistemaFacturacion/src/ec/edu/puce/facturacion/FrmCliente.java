...
public class FrmCliente extends JInternalFrame {
	...
	public FrmCliente() {
		...
		lblNewLabel_5.setFont(new Font("Tw Cen MT Condensed Extra Bold", Font.PLAIN, 14));
		...
		btnNuevo.setFont(new Font("Tw Cen MT Condensed Extra Bold", Font.PLAIN, 14));
		...
		btnCancelar.setFont(new Font("Tw Cen MT Condensed Extra Bold", Font.PLAIN, 14));
		...
		btnGuardar.setFont(new Font("Tw Cen MT Condensed Extra Bold", Font.PLAIN, 14));
	...
	private void crearCliente() {
		cliente.setCedula(txtCedula.getText().toUpperCase());
		cliente.setNombre(txtNombres.getText().toUpperCase());
		cliente.setApellido(txtApellidos.getText().toUpperCase());
