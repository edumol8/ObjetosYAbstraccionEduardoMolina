...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		mntmNewMenuItem_1.setFont(new Font("Tw Cen MT Condensed Extra Bold", Font.PLAIN, 14));
		mnNewMenu.add(mntmNewMenuItem_1);
		
		JMenu mnNewMenu_3 = new JMenu("Clientes");
		mnNewMenu_3.setFont(new Font("Tw Cen MT Condensed Extra Bold", Font.PLAIN, 14));
		menuBar.add(mnNewMenu_3);
		
		JMenuItem mntmNewMenuItem_4 = new JMenuItem("Crear Clientes");
		mntmNewMenuItem_4.setFont(new Font("Tw Cen MT Condensed Extra Bold", Font.PLAIN, 14));
		...
		mntmNewMenuItem_5.setFont(new Font("Tw Cen MT Condensed Extra Bold", Font.PLAIN, 14));
		...
		mnNewMenu_1.setFont(new Font("Tw Cen MT Condensed Extra Bold", Font.PLAIN, 14));
		menuBar.add(mnNewMenu_1);
		
		JMenuItem mntmNewMenuItem = new JMenuItem("Crear Producto");
		mntmNewMenuItem.setFont(new Font("Tw Cen MT Condensed Extra Bold", Font.PLAIN, 14));
		mnNewMenu_1.add(mntmNewMenuItem);
		
		JMenuItem mntmNewMenuItem_2 = new JMenuItem("Lista Productos");
		mntmNewMenuItem_2.setFont(new Font("Tw Cen MT Condensed Extra Bold", Font.PLAIN, 14));
		mnNewMenu_1.add(mntmNewMenuItem_2);
		
		JMenu mnNewMenu_2 = new JMenu("Redes Sociales");
		mnNewMenu_2.setFont(new Font("Tw Cen MT Condensed Extra Bold", Font.PLAIN, 14));
		menuBar.add(mnNewMenu_2);
		
		JMenuItem mntmNewMenuItem_3 = new JMenuItem("Facebook");
		mntmNewMenuItem_3.setFont(new Font("Tw Cen MT Condensed Extra Bold", Font.PLAIN, 14));
